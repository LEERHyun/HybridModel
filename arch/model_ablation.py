...
###########################################################################
#Upsample, Downsample, Pooling---------------------------------------
###########################################################################

## Resizing modules
class Downsample_Pooling(nn.Module):
    def __init__(self, n_feat):
        super().__init__()
...
class Upsample_Pooling(nn.Module):
    def __init__(self, n_feat):
        super().__init__()
        self.body = nn.Sequential(
...
#################################################################################
class Light_SplitNet(nn.Module):
    def __init__(self, input_channels=3, base_channels=32, num_heads=1, ffn_expansion_factor=2, bias=False, LayerNorm_type='WithBias'):
        super(Light_SplitNet, self).__init__()
        
        # ============ Initial Convolution ============
        self.intro = nn.Conv2d(input_channels, base_channels, 3, 1, 1)
        
        # ============ Stage 1: 1개씩 → 2 outputs ============
        self.stage1_transformer1 = TransformerBlock(base_channels, num_heads, ffn_expansion_factor, bias, LayerNorm_type)
        ...
        self.stage2_transformer1 = CNNBlock(base_channels)
        self.stage2_cnn1 = CNNBlock(base_channels)
        self.stage2_transformer2 = CNNBlock(base_channels)
        ...
        self.stage3_transformer1 = CNNBlock(base_channels)
        self.stage3_cnn1 = CNNBlock(base_channels)
        self.stage3_transformer2 = CNNBlock(base_channels)
        self.stage3_cnn2 = CNNBlock(base_channels)
        self.stage3_transformer3 = CNNBlock(base_channels)
        self.stage3_cnn3 = CNNBlock(base_channels)
        self.stage3_transformer4 = CNNBlock(base_channels)
        ...
        self.dec3_transformer1 = CNNBlock(base_channels)
        self.dec3_cnn1 = CNNBlock(base_channels)
        self.dec3_transformer2 = CNNBlock(base_channels)
        self.dec3_cnn2 = CNNBlock(base_channels)
        self.dec3_transformer3 = CNNBlock(base_channels)
        self.dec3_cnn3 = CNNBlock(base_channels)
        self.dec3_transformer4 = CNNBlock(base_channels)
        ...
        self.dec2_transformer1 = CNNBlock(base_channels)
        self.dec2_cnn1 = CNNBlock(base_channels)
        self.dec2_transformer2 = CNNBlock(base_channels)
        ...
        self.dec1_transformer1 = TransformerBlock(base_channels, num_heads, ffn_expansion_factor, bias, LayerNorm_type)
...
#################################################################################    
# Hybrid Split Network Pooling---------------------------------------------------
#################################################################################
class Light_SplitNet_Pooling(nn.Module):
    def __init__(self, input_channels=3, base_channels=32, num_heads=1, ffn_expansion_factor=2, bias=False, LayerNorm_type='WithBias'):
        super(Light_SplitNet_Pooling, self).__init__()
        ...
        self.downsample1_t1 = Downsample_Pooling(base_channels)
        self.downsample1_c1 = Downsample_Pooling(base_channels)
        ...
        self.downsample2_t1 = Downsample_Pooling(base_channels)
        self.downsample2_c1 = Downsample_Pooling(base_channels)
        self.downsample2_t2 = Downsample_Pooling(base_channels)
        self.downsample2_c2 = Downsample_Pooling(base_channels)
        ...
        self.downsample3_t1 = Downsample_Pooling(base_channels)
        self.downsample3_c1 = Downsample_Pooling(base_channels)
        self.downsample3_t2 = Downsample_Pooling(base_channels)
        self.downsample3_c2 = Downsample_Pooling(base_channels)
        self.downsample3_t3 = Downsample_Pooling(base_channels)
        self.downsample3_c3 = Downsample_Pooling(base_channels)
        self.downsample3_t4 = Downsample_Pooling(base_channels)
        self.downsample3_c4 = Downsample_Pooling(base_channels)
        ...
        # ============ Decoder Stage 3: 8개씩 ============
        self.upsample3_t1 = Upsample_Pooling(base_channels*2)
        self.upsample3_c1 = Upsample_Pooling(base_channels*2)
        self.upsample3_t2 = Upsample_Pooling(base_channels*2)
        self.upsample3_c2 = Upsample_Pooling(base_channels*2)
        self.upsample3_t3 = Upsample_Pooling(base_channels*2)
        self.upsample3_c3 = Upsample_Pooling(base_channels*2)
        self.upsample3_t4 = Upsample_Pooling(base_channels*2)
        self.upsample3_c4 = Upsample_Pooling(base_channels*2)
        ...
        # ============ Decoder Stage 2: 4개씩 ============
        self.upsample2_t1 = Upsample_Pooling(base_channels*2)
        self.upsample2_c1 = Upsample_Pooling(base_channels*2)
        self.upsample2_t2 = Upsample_Pooling(base_channels*2)
        self.upsample2_c2 = Upsample_Pooling(base_channels*2)
        ...
        # ============ Decoder Stage 1: 2개씩 ============
        self.upsample1_t1 = Upsample_Pooling(base_channels*2)
        self.upsample1_c1 = Upsample_Pooling(base_channels*2)
...
if __name__ == '__main__':
    ...
    macs, params = get_model_complexity_info(custom, (3,512, 512), verbose=False, print_per_layer_stat=False)
